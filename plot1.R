...
##
## The rest is routine that is, source the code and run "plot1()" in your console
...
hist(hp2days$Global_active_power, col="red", main = "Global Active Power", xlab="Global Active Power (kilowatts)")
